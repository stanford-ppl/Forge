...
trait RewriteOpsExp extends RewriteOps with PrimitiveOpsExp with DenseVectorOpsExp with DenseVectorViewOpsExp {
  this: OptiLAExp =>
...
//    case (y, Const(1 | 1.0 | 1.0f)) => y
  ...
  override def primitive_forge_int_plus(__arg0: Exp[Int],__arg1: Exp[Int])(implicit __pos: SourceContext) = simplify_plus(__arg0, __arg1).getOrElse(super.primitive_forge_int_plus(__arg0,__arg1))
  override def primitive_forge_int_minus(__arg0: Exp[Int],__arg1: Exp[Int])(implicit __pos: SourceContext) = simplify_minus(__arg0, __arg1).getOrElse(super.primitive_forge_int_minus(__arg0,__arg1))
  override def primitive_forge_int_times(__arg0: Exp[Int],__arg1: Exp[Int])(implicit __pos: SourceContext) = simplify_times(__arg0, __arg1).getOrElse(super.primitive_forge_int_times(__arg0,__arg1))
  override def primitive_forge_int_divide(__arg0: Exp[Int],__arg1: Exp[Int])(implicit __pos: SourceContext) = simplify_numeric_divide(__arg0, __arg1).getOrElse(super.primitive_forge_int_divide(__arg0,__arg1))
  override def primitive_forge_float_plus(__arg0: Exp[Float],__arg1: Exp[Float])(implicit __pos: SourceContext) = simplify_plus(__arg0, __arg1).getOrElse(super.primitive_forge_float_plus(__arg0,__arg1))
  override def primitive_forge_float_minus(__arg0: Exp[Float],__arg1: Exp[Float])(implicit __pos: SourceContext) = simplify_minus(__arg0, __arg1).getOrElse(super.primitive_forge_float_minus(__arg0,__arg1))
  override def primitive_forge_float_times(__arg0: Exp[Float],__arg1: Exp[Float])(implicit __pos: SourceContext) = simplify_times(__arg0, __arg1).getOrElse(super.primitive_forge_float_times(__arg0,__arg1))
  override def primitive_forge_float_divide(__arg0: Exp[Float],__arg1: Exp[Float])(implicit __pos: SourceContext) = simplify_fractional_divide(__arg0, __arg1).getOrElse(super.primitive_forge_float_divide(__arg0,__arg1))
  override def primitive_forge_double_plus(__arg0: Exp[Double],__arg1: Exp[Double])(implicit __pos: SourceContext) = simplify_plus(__arg0, __arg1).getOrElse(super.primitive_forge_double_plus(__arg0,__arg1))
  override def primitive_forge_double_minus(__arg0: Exp[Double],__arg1: Exp[Double])(implicit __pos: SourceContext) = simplify_minus(__arg0, __arg1).getOrElse(super.primitive_forge_double_minus(__arg0,__arg1))
  override def primitive_forge_double_times(__arg0: Exp[Double],__arg1: Exp[Double])(implicit __pos: SourceContext) = simplify_times(__arg0, __arg1).getOrElse(super.primitive_forge_double_times(__arg0,__arg1))
  override def primitive_forge_double_divide(__arg0: Exp[Double],__arg1: Exp[Double])(implicit __pos: SourceContext) = simplify_fractional_divide(__arg0, __arg1).getOrElse(super.primitive_forge_double_divide(__arg0,__arg1))
  override def primitive_forge_long_plus(__arg0: Exp[Long],__arg1: Exp[Long])(implicit __pos: SourceContext) = simplify_plus(__arg0, __arg1).getOrElse(super.primitive_forge_long_plus(__arg0,__arg1))
  override def primitive_forge_long_minus(__arg0: Exp[Long],__arg1: Exp[Long])(implicit __pos: SourceContext) = simplify_minus(__arg0, __arg1).getOrElse(super.primitive_forge_long_minus(__arg0,__arg1))
  override def primitive_forge_long_times(__arg0: Exp[Long],__arg1: Exp[Long])(implicit __pos: SourceContext) = simplify_times(__arg0, __arg1).getOrElse(super.primitive_forge_long_times(__arg0,__arg1))
  override def primitive_forge_long_divide(__arg0: Exp[Long],__arg1: Exp[Long])(implicit __pos: SourceContext) = simplify_numeric_divide(__arg0, __arg1).getOrElse(super.primitive_forge_long_divide(__arg0,__arg1))

  // const promotions

  override def primitive_toint[T:Numeric:Manifest](__arg0: Rep[T])(implicit __pos: SourceContext) = __arg0 match {
    case Const(x) => Const(x.toInt)
    case _ => super.primitive_toint(__arg0)
  }
  override def primitive_tofloat[T:Numeric:Manifest](__arg0: Rep[T])(implicit __pos: SourceContext) = __arg0 match {
    case Const(x) => Const(x.toFloat)
    case _ => super.primitive_tofloat(__arg0)
  }
  override def primitive_todouble[T:Numeric:Manifest](__arg0: Rep[T])(implicit __pos: SourceContext) = __arg0 match {
  ...
  override def primitive_repint2torepdouble(__arg0: Rep[Int])(implicit __pos: SourceContext) = __arg0 match {
    case Const(x) => Const(x.toDouble)
    case _ => super.primitive_repint2torepdouble(__arg0)
  }
  override def primitive_repint2torepfloat(__arg0: Rep[Int])(implicit __pos: SourceContext) = __arg0 match {
    case Const(x) => Const(x.toFloat)
    case _ => super.primitive_repint2torepfloat(__arg0)
  }
  override def primitive_repfloat2torepdouble(__arg0: Rep[Float])(implicit __pos: SourceContext) = __arg0 match {
    case Const(x) => Const(x.toDouble)
    case _ => super.primitive_repfloat2torepdouble(__arg0)
  }
