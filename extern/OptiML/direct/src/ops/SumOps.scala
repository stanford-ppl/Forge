...
trait CanSumOps extends Base {
  ...
  implicit def canSumView[A:Typ:Arith]: CanSum[DenseVector[A],DenseVectorView[A]] = new CanSum[DenseVector[A],DenseVectorView[A]] {
  ...
  implicit def canSumDenseVector[A:Typ:Arith]: CanSum[DenseVector[A],DenseVector[A]] = new CanSum[DenseVector[A],DenseVector[A]] {
  ...
  implicit def canSumDenseMatrix[A:Typ:Arith]: CanSum[DenseMatrix[A],DenseMatrix[A]] = new CanSum[DenseMatrix[A],DenseMatrix[A]] {
  ...
  implicit def canSumNumeric[A:Typ:Numeric:Arith]: CanSum[A,A] = new CanSum[A,A] {
...
trait SumOps extends CanSumOps {
  ...
  def sum[A:Typ:Arith](start: Rep[Int], end: Rep[Int])(block: Rep[Int] => Rep[A])(implicit cs: CanSum[A,A], ctx: SourceContext) = optiml_sum(start, end, block)
  ...
  def sumRows[A:Typ:Arith](start: Rep[Int], end: Rep[Int])(block: Rep[Int] => Rep[DenseVectorView[A]])(implicit cs: CanSum[A,A], ctx: SourceContext) = optiml_sumif[DenseVector[A],DenseVectorView[A]](start,end,i => unit(true),block)
  def sumIf[A:Typ:Arith](start: Rep[Int], end: Rep[Int])(cond: Rep[Int] => Rep[Boolean])(block: Rep[Int] => Rep[A])(implicit cs: CanSum[A,A], ctx: SourceContext) = optiml_sumif[A,A](start,end,cond,block)
  def sumRowsIf[A:Typ:Arith](start: Rep[Int], end: Rep[Int])(cond: Rep[Int] => Rep[Boolean])(block: Rep[Int] => Rep[DenseVectorView[A]])(implicit cs: CanSum[A,A], ctx: SourceContext) = optiml_sumif[DenseVector[A],DenseVectorView[A]](start,end,cond,block)

  def optiml_sum[A:Typ:Arith](start: Rep[Int], end: Rep[Int], block: Rep[Int] => Rep[A])(implicit cs: CanSum[A,A], ctx: SourceContext): Rep[A]
  def optiml_sumif[R:Typ:Arith,A:Typ](start: Rep[Int], end: Rep[Int], cond: Rep[Int] => Rep[Boolean], block: Rep[Int] => Rep[A])(implicit cs: CanSum[R,A], ctx: SourceContext): Rep[R]
}
