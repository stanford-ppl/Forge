...
trait ForgeArrayOps extends Base with OverloadHack {
   ...
   */
  type ForgeArray[T]
  implicit def forgeArrayManifest[T:Typ]: Typ[ForgeArray[T]]
   ...
   */
  implicit class ForgeArrayOps[T:Typ](x: Rep[ForgeArray[T]]) {
    def apply(n: Rep[Int])(implicit ctx: SourceContext) = array_apply(x,n)
    def length = array_length(x)
  }

  def array_apply[T:Typ](__arg0: Rep[ForgeArray[T]],__arg1: Rep[Int])(implicit __imp0: SourceContext): Rep[T]
  def array_length[T:Typ](__arg0: Rep[ForgeArray[T]])(implicit __imp0: SourceContext): Rep[Int]
  def array_empty_imm[T:Typ](__arg0: Rep[Int])(implicit __imp0: SourceContext): Rep[ForgeArray[T]]

  /* Required for apps to be able use 'args' */
  implicit class ScalaArrayOps[T:Typ](x: Rep[Array[T]]) {
  ...
  def infix_length[T:Typ](x: Rep[Array[T]])(implicit __imp0: SourceContext, o:Overloaded1) = scala_array_length(x)
  def scala_array_apply[T:Typ](x: Rep[Array[T]], n: Rep[Int])(implicit __imp0: SourceContext): Rep[T]
  def scala_array_length[T:Typ](x: Rep[Array[T]])(implicit __imp0: SourceContext): Rep[Int]
}
trait ForgeArrayCompilerOps extends ForgeArrayOps {
   ...
   */
  object Array {
    def empty[T:Typ](__arg0: Rep[Int])(implicit __imp0: SourceContext) = array_empty[T](__arg0)
    def copy[T:Typ](__arg0: Rep[ForgeArray[T]],__arg1: Rep[Int],__arg2: Rep[ForgeArray[T]],__arg3: Rep[Int],__arg4: Rep[Int])(implicit __imp0: SourceContext) = array_copy(__arg0,__arg1,__arg2,__arg3,__arg4)
  }

  implicit class ForgeArrayCompilerOps[T:Typ](x: Rep[ForgeArray[T]]) {
    def update(n: Rep[Int], y: Rep[T])(implicit ctx: SourceContext) = array_update(x,n,y)
    def map[R:Typ](f: Rep[T] => Rep[R])(implicit ctx: SourceContext) = array_map[T,R](x,f)
    def Clone(implicit ctx: SourceContext) = array_clone(x)
  }

  def farray_from_sarray[T:Typ](__arg0: Rep[Array[T]])(implicit __imp0: SourceContext): Rep[ForgeArray[T]]
  def array_empty[T:Typ](__arg0: Rep[Int])(implicit __imp0: SourceContext): Rep[ForgeArray[T]]
  def array_raw_alloc[T:Typ](__arg0: Rep[ForgeArray[T]],__arg1: Rep[Int])(implicit __imp0: SourceContext): Rep[ForgeArray[T]] = array_empty[T](__arg1)
  def array_copy[T:Typ](__arg0: Rep[ForgeArray[T]],__arg1: Rep[Int],__arg2: Rep[ForgeArray[T]],__arg3: Rep[Int],__arg4: Rep[Int])(implicit __imp0: SourceContext): Rep[Unit]
  def array_update[T:Typ](__arg0: Rep[ForgeArray[T]],__arg1: Rep[Int],__arg2: Rep[T])(implicit __imp0: SourceContext): Rep[Unit]
  def array_clone[T:Typ](__arg0: Rep[ForgeArray[T]])(implicit __imp0: SourceContext): Rep[ForgeArray[T]]
  def array_soft_clone[T:Typ](__arg0: Rep[ForgeArray[T]])(implicit __imp0: SourceContext): Rep[ForgeArray[T]]
  def array_take[T:Typ](__arg0: Rep[ForgeArray[T]],__arg1: Rep[Int]): Rep[ForgeArray[T]]
  def array_mkstring[A:Typ](__arg0: Rep[ForgeArray[A]],__arg1: Rep[String])(implicit __imp0: SourceContext): Rep[String]
  def array_map[T:Typ,R:Typ](__arg0: Rep[ForgeArray[T]], __arg1: Rep[T] => Rep[R])(implicit __imp0: SourceContext): Rep[ForgeArray[R]]
  def array_flatmap[T:Typ,R:Typ](__arg0: Rep[ForgeArray[T]], __arg1: Rep[T] => Rep[ForgeArray[R]])(implicit __imp0: SourceContext): Rep[ForgeArray[R]]
  def array_zip[T:Typ,B:Typ,R:Typ](__arg0: Rep[ForgeArray[T]],__arg1: Rep[ForgeArray[B]], __arg2: (Rep[T],Rep[B]) => Rep[R])(implicit __imp0: SourceContext): Rep[ForgeArray[R]]
  def array_groupByReduce[T:Typ,K:Typ,V:Typ](__arg0: Rep[ForgeArray[T]],__arg1: Rep[T] => Rep[K], __arg2: Rep[T] => Rep[V], __arg3: (Rep[V],Rep[V]) => Rep[V])(implicit __imp0: SourceContext): Rep[ForgeHashMap[K,V]]
  def array_reduce[T:Typ](__arg0: Rep[ForgeArray[T]],__arg1: (Rep[T],Rep[T]) => Rep[T],__arg2: Rep[T])(implicit __imp0: SourceContext): Rep[T]
  def array_filter[T:Typ](__arg0: Rep[ForgeArray[T]],__arg1: Rep[T] => Rep[Boolean])(implicit __imp0: SourceContext): Rep[ForgeArray[T]]
  def array_sort[T:Typ:Ordering](__arg0: Rep[ForgeArray[T]])(implicit __imp0: SourceContext): Rep[ForgeArray[T]]
  def array_fromfunction[T:Typ](__arg0: Rep[Int],__arg1: Rep[Int] => Rep[T])(implicit __imp0: SourceContext): Rep[ForgeArray[T]]
  def array_fromseq[T:Typ](__arg0: Seq[Rep[T]])(implicit __imp0: SourceContext): Rep[ForgeArray[T]]
  ...
  def array_sortIndices[R:Typ:Ordering](__arg0: Rep[Int], __arg1: (Rep[Int] => Rep[R]))(implicit __imp0: SourceContext): Rep[ForgeArray[Int]]

  def scala_array_apply[T:Typ](__arg0: Rep[Array[T]],__arg1: Rep[Int])(implicit __imp0: SourceContext): Rep[T]
  def scala_array_length[T:Typ](__arg0: Rep[Array[T]])(implicit __imp0: SourceContext): Rep[Int]
}

trait ForgeArrayBufferOps extends Base {
  type ForgeArrayBuffer[T]
  implicit def forgeArrayBufferManifest[T:Typ]: Typ[ForgeArrayBuffer[T]]
}
