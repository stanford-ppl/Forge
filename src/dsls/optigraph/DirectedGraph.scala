...
trait DirectedGraphOps{
  ...
  def importDirectedGraphOps() {
    ...
    DirectedGraphOps{
      ...
      //Out Node Accessors
      internal ("out_node_raw_data") (Nil :: MArray(MInt)) implements getter(0, "_outNodes")
      internal ("out_node_apply") (MInt :: MInt) implements composite ${array_apply(out_node_raw_data($self),$1)}
      internal ("out_edge_raw_data") (Nil :: MArray(MInt)) implements getter(0, "_outEdges")
      internal ("out_edge_apply") (MInt :: MInt) implements composite ${array_apply(out_edge_raw_data($self),$1)}

      //In Node Accessors
      internal ("in_node_raw_data") (Nil :: MArray(MInt)) implements getter(0, "_inNodes")
      internal ("in_node_apply") (MInt :: MInt) implements composite ${array_apply(in_node_raw_data($self),$1)}
      internal ("in_edge_raw_data") (Nil :: MArray(MInt)) implements getter(0, "_inEdges")
      internal ("in_edge_apply") (MInt :: MInt) implements composite ${array_apply(in_edge_raw_data($self),$1)}
    }
