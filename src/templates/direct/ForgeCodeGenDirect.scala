...
trait ForgeCodeGenDirect extends ForgeCodeGenBackend with BaseGenPackages with BaseGenLifts with BaseGenOps with BaseGenImports with BaseGenTypeClasses {
  val IR: ForgeApplicationRunner with ForgeExp
  import IR._

  lazy val dslStream = new PrintWriter(new FileWriter(dslDir+"Frontend.scala"))
  lazy val targetName = "direct"
