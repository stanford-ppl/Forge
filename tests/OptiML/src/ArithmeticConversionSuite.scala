...
class ArithmeticConversionSuiteInterpreter extends ForgeSuiteInterpreter {
  def testPrimitiveConversions() { runTest(PrimitiveConversionsRunnerI) }
  def testDenseVectorConversions() { runTest(DenseVectorConversionsRunnerI) }
  def testDenseMatrixConversions() { runTest(DenseMatrixConversionsRunnerI) }
}

class ArithmeticConversionSuiteCompiler extends ForgeSuiteCompiler {
  def testPrimitiveConversions() { runTest(PrimitiveConversionsRunnerC) }
  def testDenseVectorConversions() { runTest(DenseVectorConversionsRunnerC) }
  def testDenseMatrixConversions() { runTest(DenseMatrixConversionsRunnerC) }
}
